...
exports.imgUrl = function(story) {
    if(!story) {
        console.log('## imgUrl helper: story undefined');
        return '';
    }
    var url = story.image;
...
exports.formatdate = function(datevalue) {
    moment.locale('en', {relativeTime: {future: "in %s",past: "%s ago",s: "s",m: "am",mm: "%dm",h: "1h",hh: "%dh",d: "1d",dd: "%dd",M: "amon",MM: "%dmon",y: "a y",yy: "%d y"}});
...
exports.ifHasKeys = function(obj) {
    var options = arguments[arguments.length - 1];
    if (Object.keys(obj).length > 0) { return options.fn(this); }
    else { return options.inverse(this); }
};
